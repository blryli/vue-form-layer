...
var script = {
  ...
  mounted() {
    this.$on('mark.to.show', this.select);
  }
...
__vue_render__._withStripped = true;
  ...
  var VueMarkContent = normalizeComponent_1(
  ...
  methods: {
    ...
    changeShow(id) {
      ...
      if (!this.layer.find(function (d) {
        return d.id && d.id === id;
      })) console.error(`not find ${id} in layer`);
        ...
        [
          ...
          _vm.mark
            ? _c("vue-form-mark", {
                attrs: {
                  id: _vm.clickItemId,
                  markEffect: _vm.markEffect,
                  markContent: _vm.markContent
                }
              })
            : _vm._e()
        ],
...
var __vue_render__$2 = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { ref: "formItemContent", staticClass: "vue-form-item__content" },
        [_vm._t("default")],
        2
      )
    ]
...
var script$5 = {
  ...
  computed: {
    ...
    pClass() {
      return `${this.effect ? `is-${this.effect}` : "is-light"}  vue-popover__${this.momentPlacement} ${this.popoverClass || ""} ${this.isVisible ? "vue-popover--visible" : "vue-popover--hidden"}`;
    },
...
var __vue_render__$3 = function() {
  ...
  return _c("transition", { attrs: { name: "fade" } }, [
    _c(
      ...
      [
        _vm.visibleArrow
          ? _c("div", { staticClass: "vue-popover__arrow" })
          : _vm._e(),
        _vm._v(" "),
        _c("vue-content", { attrs: { data: _vm.data } })
      ],
      1
    )
  ])
  ...
  mounted() {
    ...
    this.$nextTick(function () {
      ...
      if (focusNodes.length === 1) {
        ...
        _this2.focusNode.style.cssText = `border: 1px solid ${_this2.borderColor || "transparent"}`;
      }
    });
  }
...
var script$a = {
  ...
  render(h) {
    ...
    (slotNodes || []).forEach(function (slotNode, index) {
      ...
      var markRefrenceClass = _this.form.mark && prop ? 'vue-form__mark-reference' : "";
